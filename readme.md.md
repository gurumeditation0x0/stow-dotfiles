...
2.  [Installer Emacs pour Linux](#emacs-pour-linux)
    1.  [Installer emacs selon la distribution.](#org650fda5)
    2.  [On peut utiliser stow au lieu de copier les répertoires manuellement.](#org6141a75)
    3.  [Configuration Gpg .authinfo](#orgd226265)
    4.  [Fichiers à éditer](#org9351bf2)
3.  [Installer Emacs pour Windows](#installer-emacs-pour-windows)
    1.  [cmd.exe](#org1214138)
    2.  [powershell](#org4f28094)
4.  [Configurer Emacs](#configurer-emacs)
    1.  [Fichiers et répertoires à copier depuis le dépôt](#orgadc0210)
    ...
    3.  [Ajouter %HOME%\\\\\bin au PATH](#ajouter-home-bin-au-path)
        ...
        5.  [CMD](#org81ee419)
        6.  [PowerShell](#org26ec928)
        7.  [Fichiers à éditer](#fichiers-a-editer)
5.  [Prise de notes Orgzly Emacs-Pour-Windows](#orga573fb6)
    1.  [Shéma de synnchronisation avec SyncThing](#org250f8dc)
    2.  [Orglzly](#org32c5279)
    3.  [Denote](#org79eda9d)
