...
2.  [Installer Emacs pour Linux](#emacs-pour-linux)
    1.  [Installer emacs selon la distribution.](#org4d847aa)
    2.  [On peut utiliser stow au lieu de copier les répertoires manuellement.](#orgc97f197)
    3.  [Configuration Gpg  .authinfo](#org3420111)
    4.  [Fichiers à éditer](#org1d4482a)
3.  [Installer Emacs pour Windows](#installer-emacs-pour-windows)
        1.  [cmd.exe](#orgad2ec68)
        2.  [powershell](#org7d04031)
4.  [Configurer Emacs](#configurer-emacs)
    1.  [Fichiers et répertoires à copier depuis le dépôt](#orga29f72d)
    ...
    3.  [Ajouter %HOME%\\\bin au PATH](#ajouter-home-bin-au-path)
        ...
        5.  [CMD](#orge958964)
        6.  [PowerShell](#orgcf7d886)
        7.  [Fichiers à éditer](#fichiers-a-editer)
5.  [Prise de notes Orgzly Emacs-Pour-Windows](#org7d1cda4)
    1.  [Shéma de synnchronisation avec SyncThing](#orge49ceef)
    2.  [Orglzly](#org5dd015c)
    3.  [Denote](#org9e288ab)
